...
;(function(factory) {
	...
	else if (typeof define === "function")  // AMD/CMD/Sea.js
	{
        ...
        {
            var cmModePath  = "./library/codemirror/mode/";
            var cmAddonPath = "./library/codemirror/addon/";

            var codeMirrorModules = [
                "jquery", "marked", "prettify",
                "katex", "raphael", "underscore", "flowchart",  "jqueryflowchart",  "sequenceDiagram",

                "./library/codemirror/library/codemirror",
                cmModePath + "css/css",
    ...
    editormd.defaults     = {
        ...
        width                : "100%",
        height               : "100%",
        path                 : "./library/",       // Dependents module file directory
